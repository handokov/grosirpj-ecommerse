      ...
      <body>
        <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
          <div className="text-center max-w-md">
            ...
            <button
              onClick={reset}
              className="inline-flex items-center gap-2 px-6 py-2.5 bg-emerald-700 text-white rounded-xl font-semibold text-sm hover:bg-emerald-800 transition-colors"
            >
              Coba Lagi
            </button>
          </div>
