...
export default function ProductCatalog() {
  ...
  useEffect(() => { if (selectedCategoryId) setFilterCategory(selectedCategoryId); }, [selectedCategoryId]);
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        {loading ? (
          ...
          <div className="text-center py-16">
            ...
            <Button variant="outline" className="rounded-xl" onClick={() => { setFilterCategory('all'); setLocalSearch(''); useStore.getState().setSearchQuery(''); setPage(1); }}>Reset Filter</Button>
          </div>
        ) : (
