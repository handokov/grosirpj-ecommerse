    ...
    <section className="py-12 md:py-16 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex items-end justify-between mb-8">
          <div>
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-sm font-semibold text-pink-600 uppercase">Best Seller</span>
            </div>
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900">Pilihan Terlaris</h2>
          </div>
          <Button variant="outline" className="hidden sm:flex border-pink-200 text-pink-700 hover:bg-pink-50" onClick={() => viewCategory(null)}>
            Lihat Semua
          </Button>
        </div>
                  ...
                  <CardContent className="p-0">
                    <div className="relative aspect-square overflow-hidden bg-gray-100">
                      ...
                      <div className="absolute inset-0 bg-black/0 group-hover:bg-black/20 transition-colors flex items-center justify-center gap-2 opacity-0 group-hover:opacity-100">
                        <Button size="icon" className="h-10 w-10 rounded-full bg-white text-gray-900 hover:bg-pink-600 hover:text-white shadow-lg" onClick={(e) => { e.stopPropagation(); addToCart(product, product.minOrder); }}>
                          <ShoppingCart className="h-4 w-4" />
                        </Button>
                        <Button size="icon" className="h-10 w-10 rounded-full bg-white text-gray-900 hover:bg-pink-600 hover:text-white shadow-lg" onClick={(e) => { e.stopPropagation(); viewProduct(product); }}>
                    ...
                    <div className="p-3">
                      ...
                      <h3 className="font-semibold text-sm text-gray-900 line-clamp-2 mb-2 cursor-pointer hover:text-pink-700 transition-colors" onClick={() => viewProduct(product)}>
                        {product.name}
                      </h3>
        ...
        <div className="text-center mt-6 sm:hidden">
          <Button variant="outline" className="border-pink-200 text-pink-700 hover:bg-pink-50" onClick={() => viewCategory(null)}>
            Lihat Semua Produk
          </Button>
        </div>
      </div>
