  ...
  return (
    <section className="py-12 md:py-16">
      <div className="max-w-7xl mx-auto px-4">
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-pink-600 via-purple-600 to-fuchsia-500 p-8 md:p-12 text-white">
          ...
          <div className="relative max-w-2xl">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <Button className="bg-yellow-400 hover:bg-yellow-500 text-gray-900 font-semibold h-12 px-8 rounded-xl text-base" onClick={() => viewCategory(null)}>
